...
$id=$row['idLocation'];
 ...
 echo "</tr>"; 
	...
	<div class="center">
		<a href="adminviewlocation.php?msg=add" class="btn btn-primary a-btn-slide-text">
        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
        <span><strong>Ekle</strong></span>            
    </a>
 
    <a href="adminviewlocation.php?msg=delete" class="btn btn-primary a-btn-slide-text">
