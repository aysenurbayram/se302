				...
				<div class="col-md-9 col-xs-12">
					<ul class="blog--list">
						<li>
							<?php
							include_once("services/manage.php");
							$getlAllSaglikliYasamBlogPosts = getlAllSaglikliYasamBlogPosts();
							if (count($getlAllSaglikliYasamBlogPosts) != 0) {

								foreach ($getlAllSaglikliYasamBlogPosts as $blog_post) { 
									echo '

									<div class="blog--item">
									<a href=blog-details.php?view="'.$blog_post["idBlog"].'" class="item--images"><img src="' . $blog_post['picture'] . '" alt=""></a>
									<div class="item--date">' . $blog_post['date'] . '</span></div>
									<div class="item--category">' . $blog_post['category']. '</div>
									<h2 class="item--title">
									<a href=blog-details.php?v,ew="'.$blog_post["idBlog"].'">' . $blog_post['title'] . '</a>
									</h2>
