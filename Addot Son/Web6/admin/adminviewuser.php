...
<?php include ("adminmenu-navigator.php"); ?>
	...
	<div class="container">
		<nav class="woocommerce-breadcrumb">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;   <a class="home" href="adminviewuser.php?msg=red"><u>Onaylanmayanlar</u></a>
		</nav>
...
<table id="customers">
  ...
  $user=mysql_query("select * from Member   where firstname='$name' ");
...
<table id="customers">
  ...
  <?php
   include("database.php"); 
  $user=mysql_query("select * from Member where role='Onayli_Uye'   OR  role='Normal_Uye'  ");
  ...
  echo"<td>".$row['role']."</td>";
   echo "</tr>"; 
	...
	<?php
	 ...
	 <?php
					  if (isset($_GET["msg"]) && $_GET["msg"] == 'red'){
...
<table id="customers">
  ...
  <?php
   include("database.php"); 
  $user=mysql_query("select * from Member where role='Reddedilen_Uye' ");
