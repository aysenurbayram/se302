			...
			<div class="header--right">
				...
				<div class="menu--header">
					<ul class="menu menu--inline linkwrap--hover-line-bottom">
						...
						<li><a href="logout.php"><i class="icon fa fa-user-md"></i> Çıkış</a></li>
...
?>	
<?php 
if (($user['role']=='Onay_Bekliyor')||($user['role']=='Onayli_Uye') ||($user['role']=='Normal_Uye')  ){
	?>
