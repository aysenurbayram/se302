<form method="post" name ="form" action="#">
				...
				<hr/>
					...
					<div id= "inform">
						Şeker Oranı
						<input type="text" name="sugar" value="" placeholder="" id="sugar" class="form-control">
					</div>
					<div id= "inform">
						Yağ
    ...
    <option value="sonbahar">Sonbahar</option>
					...
					<div id= "inform">
						Ürün Resmi (Ürün resminin bağlantısını girin.)
...
<br/>
	...
	if((empty($referance))  ){
		...
		$sorgu = mysql_query("insert into suggest_item(name, protein, vitamin,fat, carbonhydrate,mineral,sugar, time, picture, description, referance, Location_idLocation, idLocalMarket) 
		VALUES ('$name','$protein','$vitamin','$fat','$carbonhydrate','$mineral','$sugar','$time','$picture','$description','$referance','$Location_idLocation','$idLocalMarket')");
